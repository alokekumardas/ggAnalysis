...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cmsxrootd.fnal.gov///store/data/Run2017B/SingleMuon/MINIAOD/31Mar2018-v1/90000/FEC62083-1E39-E811-B2A1-0CC47A4D75F8.root')
)
...
process.patJetCorrFactorsReapplyJECModifiedMET = cms.EDProducer("JetCorrFactorsProducer",
    ...
    rho = cms.InputTag("fixedGridRhoFastjetAll"),
    src = cms.InputTag("PFCandidateJetsWithEEnoiseModifiedMET","jets"),
    useNPV = cms.bool(True),
    useRho = cms.bool(True)
)
...
process.patJetsReapplyJECModifiedMET = cms.EDProducer("PATJetUpdater",
    ...
    jetSource = cms.InputTag("PFCandidateJetsWithEEnoiseModifiedMET","jets"),
...
process.superbadModifiedMET = cms.EDProducer("CandViewMerger",
    src = cms.VInputTag(cms.InputTag("badUnclusteredModifiedMET"), cms.InputTag("PFCandidateJetsWithEEnoiseModifiedMET"))
)
...
process.egammaScaleSmearTask = cms.Task(process.calibratedPatElectrons, process.calibratedPatPhotons, process.slimmedElectrons, process.slimmedPhotons)
...
process.p = cms.Path(process.fullPatMetSequenceModifiedMET+process.ggNtuplizer)
